const data = {
  ...
  opasnye: {
    data: [
      ...
      },
      {
        ...
        phrase:
          "Отмечается сужение жизненной перспективы, пессимистическое восприятие дальнейшей жизни, при этом cуицидальные мысли и намерения отрицает"
      },
      {
        id: 2,
  ...
  opasnyeAgressia: {
    data: [
      ...
      {
        id: 2,
        label: "вербальная агрессия",
        phrase: "Проявляет вербальную агрессию к окружающим."
      },
      {
        id: 3,
        label: "физическая агрессия",
        phrase: "Проявляет физическую агрессию к окружающим."
      }
    ],
    label: "Агрессия",
    type: "radio",
